    ...
    for (const fieldName of Object.keys(fields)) {
        ...
        if (field.type === "object") {
            if (field.fields && Object.keys(field.fields).length > 0) {
                ...
                throw new mobiletto_orm_typedef_1.MobilettoOrmError(`buildTypeFields: indeterminate fields for object: ${field.name}`);
            }
        }
            ...
            if (field.values && field.values.length && field.values.length > 0) {
                ...
                throw new mobiletto_orm_typedef_1.MobilettoOrmError(`buildTypeFields: indeterminate value type for array: ${field.name}`);
            }
            fieldCode += valueType + "[]";
        }
        else {

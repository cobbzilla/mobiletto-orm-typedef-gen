...
export declare const generateAdmin: (typeDef: MobilettoOrmTypeDef | MobilettoOrmTypeDefConfig, typeDefPackage: string, opts?: GenerateOptions, adminHelperPath?: string, sessionStoreImport?: string, localeMessages?: string) => string;

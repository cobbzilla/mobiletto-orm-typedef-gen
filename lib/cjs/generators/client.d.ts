...
export declare const generateAdmin: (typeDef: MobilettoOrmTypeDef | MobilettoOrmTypeDefConfig, typeDefPackage: string, opts?: GenerateOptions, utilsImportPath?: string, adminHelperPath?: string, sessionStoreImport?: string, localeMessages?: string) => string;

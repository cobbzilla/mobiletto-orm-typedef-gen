...
export declare const generateApi: (typeDef: MobilettoOrmTypeDef | MobilettoOrmTypeDefConfig, typeDefPackage: string, opts?: GenerateOptions, utilsImportPath?: string) => Record<string, string>;
